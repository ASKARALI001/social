            ...
            <div className="container">
                ...
                <div className="profile__addPost">
                    <div className="profile__addPost-top">
                        <textarea value={post} onChange={(e) => setPost(e.target.value)} className='profile__addPost-field' placeholder='что у вас нового ? '/>
                        {
                            selectEmoji ? <div className='profile__emoji-block' onMouseLeave={() => setSelectEmoji(false)} >
                                ...
                                <span onMouseEnter={() => setSelectEmoji(true)} className="profile__addPost-emoji" >
                    ...
                    <Button onClick={addPost} colorSchem='teal' variant='outline'>
                        button
                    </Button>
                </div>
                <div className='profile__posts'>
                    ...
                    <div className="profile__posts-row">
                        ...
                        {
                            user.posts.map((item) => (
                                <div key={item._id} className="profile__posts-card">
                                    <div className='profile__posts-top'>
                                        {format(item.date)}
                                    </div>
                                    <p className='profile__posts-card-text'>{item.text}</p>
